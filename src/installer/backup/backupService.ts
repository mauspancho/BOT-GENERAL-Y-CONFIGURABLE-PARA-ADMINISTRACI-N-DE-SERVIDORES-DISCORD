...
export function createBackup(reason = "manual"): BackupResult {
  ...
  copyIfExists(path.join(projectRoot, "data", "guilds"), path.join(targetDir, "data", "guilds"), included, "data/guilds/");
...
export function restoreBackup(name: string): BackupResult {
  ...
  copyIfExists(path.join(sourceDir, "data", "guilds"), path.join(projectRoot, "data", "guilds"), restored, "data/guilds/");
